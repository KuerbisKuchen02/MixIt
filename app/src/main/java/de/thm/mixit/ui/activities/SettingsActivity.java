...
public class SettingsActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Font Size Spinner
        Spinner spinnerFontSize = findViewById(R.id.spinner_settings_font_size);
        ArrayAdapter<CharSequence> adapterFontSize = ArrayAdapter.createFromResource(
    ...
    /**
     * refs: <a href="https://developer.android.com/develop/ui/views/theming/darktheme#change-themes">...</a>
     */
    private void preselectThemeSpinner() {
        int selection = 0; // default: system
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (viewId == R.id.spinner_settings_language) {
            String[] values = getResources().getStringArray(R.array.language_values); // "system", "en", "de"
            ...
            // refs: https://developer.android.com/guide/topics/resources/app-languages#androidx-impl
            AppCompatDelegate.setApplicationLocales(locales);
        } else if (viewId == R.id.spinner_settings_theme) {
            String[] values = getResources().getStringArray(R.array.theme_values); // "system","light","dark"
            String selectedTheme = values[position];
            Log.d(TAG, "Theme selected: " + selectedTheme);
            applyTheme(selectedTheme);
        } else if (viewId == R.id.spinner_settings_font_size) {
            Log.d(TAG, "Font size selected: " + parent.getItemAtPosition(position));
        }
    }
